...
class Vector3 {
    ...
    static dot(other1, other2) {
        let v1Elements = other1.elements;
        let v2Elements = other2.elements;
        
        // Calculate the magnitudes (lengths) of the vectors
        let magnitudeV1 = other1.magnitude();
        let magnitudeV2 = other2.magnitude();
        
        // Calculate the dot product using the formula: dot(v1, v2) = ||v1|| * ||v2|| * cos(alpha)
        let cosineAlpha = (v1Elements[0] * v2Elements[0] + v1Elements[1] * v2Elements[1] + v1Elements[2] * v2Elements[2]) / (magnitudeV1 * magnitudeV2);
        
        return magnitudeV1 * magnitudeV2 * cosineAlpha;
    }
    ...
    static cross(other1, other2) {
        ...
        let v3x = v1[1] * v2[2] - v1[2] * v2[1];
        let v3y = v1[2] * v2[0] - v1[0] * v2[2];
        let v3z = v1[0] * v2[1] - v1[1] * v2[0];
    ...
    normalize() {
        ...
        let x = this.elements[0] / mag;
        let y = this.elements[1] / mag;
        let z = this.elements[2] / mag;
        this.elements[0] = x;
        this.elements[1] = y;
        this.elements[2] = z;
        return this;
